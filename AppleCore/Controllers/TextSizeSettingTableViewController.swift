//
//  TextSizeSettingTableViewController.swift
//  AppleCore
//
...
protocol TextSizeSettingTableViewControllerDelegate: class{
    func viewControllerDidCancel(_ controller: TextSizeSettingTableViewController)
    
}

class TextSizeSettingTableViewController: UITableViewController {

    
    weak var delegate: TextSizeSettingTableViewControllerDelegate?
